...
btnCart.addEventListener("click", function addToCart() {
  ...
  // Va trouver la couleur et l'id dans "cart" avec la méthode find(). Fais la correspondance avec l'id pour savoir si la couleur dans le "cart" est égale à la couleur de l'article que l'on veut ajouter.
  let found = cart.find(
    (element) =>
